  ...
  return (
    <div className="">
      <div className="absolute text-sm top-0 w-screen flex items-center justify-between bg-white py-2 px-30 border-b border-zinc-300 shadow-sm">
        ...
        <Link
          href="/affiliate"
          className="flex items-center gap-3 py-1.5 px-4 rounded-lg font-light bg-linear-to-r from-[#5D51FF] to-blue-500 hover:from-blue-500 hover:to-[#5D51FF] transition-colors duration-300"
        >

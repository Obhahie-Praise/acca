...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-15 left-1/2 -translate-x-1/2 flex items-center justify-between w-4xl py-2 px-10 border border-zinc-300 bg-white/30 backdrop-blur-lg rounded-full z-50">
